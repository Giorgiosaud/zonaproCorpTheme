 ...
 */
 ...
 elixir(function(mix) {
	...
	.copy('vendor/bower_components/slick-carousel/slick/fonts/','compiled/fonts/')
	 ...
	 .copy('vendor/bower_components/slick-carousel/slick/slick.js','resources/assets/js')
	...
	.styles(['app.css'],'compiled/css/main.css')
 	.scripts(['jquery.js','tether.js','bootstrap.js','Parallax.js','slick.js','sweetalert.min.js'],'compiled/js/assets.js')
